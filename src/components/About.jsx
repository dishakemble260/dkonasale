...
const About = () => {
  return (
    <section
      className="w-full bg-[#F5EFE7] py-8 sm:py-12 md:py-16 lg:py-20"
      style={{ fontFamily: "Poppins, sans-serif" }}
    >
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
        <div className="flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-8 lg:gap-12">
          {/* Left: Large Image */}
          <div className="w-full md:w-1/2 h-[400px] sm:h-[500px] md:h-[600px] lg:h-[650px] overflow-hidden rounded-lg">
            <img
              src={bigImage}
              alt="Author portrait"
          ...
          {/* Right: Content + small image */}
          <div className="w-full md:w-1/2 flex flex-col justify-center px-2 sm:px-4 md:px-0">
            {/* Small Title Image */}
            ...
            {/* Text Content */}
            <p className="text-sm sm:text-base md:text-lg leading-relaxed text-gray-700 space-y-4">
              I was fifteen when words first became my escape. What began as
              scribbled verses in silence grew into a voice—one that speaks of
              love, pain, and the haunting beauty of emotions too heavy to hold.
              <br /><br />
              I don't come from an artistic or literary background. You might
              ask how I became a poet, and I could call it an accident—but I
              don't really believe in accidents. My first book, <span className="italic">Alamort: Soft
              Burning Emotions</span>, was never part of my plan. Yet every poem in it
              tells fragments of my life, carrying emotions that trace back to
              when I was just a child.
              <br /><br />
              For me, writing is not just an act—it's like breathing. I don't write 
              stories that appear randomly in my mind; I live them, feel them, and 
              shape them into words. My hope is that if you've ever felt lost, broken, 
              or unseen, you will find a piece of yourself in my poetry and know that 
              you are not alone.
              <br /><br />
              I am now working on my first novel, and I know this is just the
              beginning of my artistic journey. I have a long way to go, and I
